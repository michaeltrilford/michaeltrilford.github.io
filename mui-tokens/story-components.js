      ...
      >
        <mui-v-stack space="var(--space-700)">
          ...
          <story-card title="Alert" nofooter>
            ...
            <mui-token-local-slat slot="body" token="--alert-border-success" output="var(--stroke-size-200) var(--stroke-style-solid) var(--feedback-positive-color)"></mui-token-local-slat>
            <mui-token-local-slat slot="body" token="--alert-border-info" output="var(--stroke-size-200) var(--stroke-style-solid) var(--feedback-info-color)"></mui-token-local-slat>
            <mui-token-local-slat slot="body" token="--alert-border-warning" output=" var(--stroke-size-200) var(--stroke-style-solid) var(--feedback-warning-color)"></mui-token-local-slat>
            <mui-token-local-slat slot="body" token="--alert-border-error" output="var(--stroke-size-200) var(--stroke-style-solid) var(--feedback-attention-color)"></mui-token-local-slat>
            
            <mui-token-local-slat slot="body" token="--alert-background-success" output="color-mix(in srgb, var(--feedback-positive-color) 10%, var(--white) 0%)"></mui-token-local-slat>
          ...
          <story-card title="Message" nofooter>
            ...
            <mui-token-local-slat slot="body" token="--message-icon-error" output="color-mix(in srgb,var(--feedback-error-color) 100%,var(--black) 20%);"></mui-token-local-slat>
          </story-card>
